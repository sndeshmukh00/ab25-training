...
const Register1 = ({navigation}) => {
  ...
  .then(res=>{
    ...
    if(res.response==="validation_error"){
      ...
      navigation.navigate("verify",{fromlogin:false,res,mobile})
    }
  })
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", }}>
      ...
      <View style={[styles.index, styles.elevation]}>
        <Text style={{ fontSize: 25, fontWeight: "bold", marginTop: 20,}}>REGISTER</Text>
        <Text style={{ fontSize: 15, marginTop: 10, }}>Create New Account By Adding Your Details</Text>
